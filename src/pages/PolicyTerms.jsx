      ...
      <div className="flex flex-col h-full w-full items-center mt-32">
        <div className="w-5/6 md:w-3/5 h-2/3 border rounded-xl shadow-xl border-purple-400 relative flex flex-col items-center justify-center">
          ...
          <p>
            ...
            personal information you provide to us when using our Google Reviews
            sales page.
          </p>
          ...
          <h2>5. We do not share your information</h2>
          <p>
            We do not share your personal information with third parties, except
            when necessary to comply with our legal obligations or to protect
          ...
          <p>
            ...
            we make changes, we will notify you by updating the date at the top
            of the policy and/or through a notification on our page.
          </p>

          <h2>7. Contact</h2>
          <p>
            If you have questions or concerns about our Privacy Policy, please
            feel free to contact us through the communication channels provided
            on our page.
          </p>
        </div>
